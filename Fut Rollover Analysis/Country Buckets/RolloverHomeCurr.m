...
austral_data    = readtable('Australian Futs HomeCurr.xlsx');
austral_ticker  = readtable('Australian Futs HomeCurr.xlsx','Sheet','Sheet2');

canad_data      = readtable('Canadian Futures HomeCurr.xlsx');
canad_ticker    = readtable('Canadian Futures HomeCurr.xlsx','Sheet','Sheet2');

french_data     = readtable('FrenchFutures HomeCurr.xlsx');
french_ticker   = readtable('FrenchFutures HomeCurr.xlsx','Sheet','Sheet2');

german_data     = readtable('GermanyFuts HomeCurr.xlsx');
german_ticker   = readtable('GermanyFuts HomeCurr.xlsx','Sheet','Sheet2');

ital_data       = readtable('Italian Futures HomeCurr.xlsx');
ital_ticker     = readtable('Italian Futures HomeCurr.xlsx','Sheet','Sheet2');

spain_data      = readtable('Spain Futures HomeCurr.xlsx');
spain_ticker    = readtable('Spain Futures HomeCurr.xlsx','Sheet','Sheet2');

swiss_data      = readtable('Swiss Futures HomeCurr.xlsx');
swiss_ticker    = readtable('Swiss Futures HomeCurr.xlsx','Sheet','Sheet2');

china_data      = readtable('China Futures HomeCurr.xlsx');
china_ticker    = readtable('China Futures HomeCurr.xlsx','Sheet','Sheet2');

japan_data      = readtable('Japan Futures HomeCurr.xlsx');
japan_ticker    = readtable('Japan Futures HomeCurr.xlsx','Sheet','Sheet2');

korea_data      = readtable('Korea Futures HomeCurr.xlsx');
korea_ticker    = readtable('Korea Futures HomeCurr.xlsx','Sheet','Sheet2');

uk_data         = readtable('UK Futures HomeCurr.xlsx');
uk_ticker       = readtable('UK Futures HomeCurr.xlsx','Sheet','Sheet2');

us_data         = readtable('USFutures HomeCurr.xlsx');
us_ticker       = readtable('USFutures HomeCurr.xlsx','Sheet','Sheet2');

%% Changes To data

% make necessary adjustments
austral_price   = str2double(table2cell(austral_data(6 : end -18, 2 : end)));
canada_price    = str2double(table2cell(canad_data(6 : end-18, 2 : end)));
french_price    = str2double(table2cell(french_data(6 : end-18, 2 : end)));
german_price    = str2double(table2cell(german_data(6 : end-18, 2 : end)));
ital_price      = str2double(table2cell(ital_data(6 : end-18, 2 : end)));
spain_price     = str2double(table2cell(spain_data(6 : end-18, 2 : end)));
swiss_price     = str2double(table2cell(swiss_data(6 : end-18, 2 : end)));
china_price     = str2double(table2cell(china_data(6 : end-18, 2 : end)));
japan_price     = str2double(table2cell(japan_data(6 : end-18, 2 : end)));
korea_price     = str2double(table2cell(korea_data(6 : end-18, 2 : end)));
uk_price        = str2double(table2cell(uk_data(6 : end-18, 2 : end)));
us_price        = str2double(table2cell(us_data(6 : end-18, 2 : end)));
...
china_ticker    = table2cell(china_ticker(6 : end -18, 2 : end));
