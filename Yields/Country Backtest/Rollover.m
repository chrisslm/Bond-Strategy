...
xlswrite("short_futures.xls", short_futures);
xlswrite("medium_futures.xls", medium_futures);
xlswrite("long_futures.xls", long_futures);
xlswrite("ultra_futures.xls", ultra_futures);
xlswrite("cumRf.xls", cumRf);
return
%% Plot graphs
% kill nans
